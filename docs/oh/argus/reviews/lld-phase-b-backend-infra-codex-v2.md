...
This is false for the current repo. [packages/db/src/index.ts](/Users/lego/Desktop/personal-projects/chatapp/packages/db/src/index.ts:25) explicitly exports a fixed type list. If builders need `InferenceKind` from `@ollive/db`, acceptance must include exporting it.
...
> “Verify: `pnpm --filter @ollive/contracts test __tests__/sse.test.ts`”
